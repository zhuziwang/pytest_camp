...
if driver.find_element_by_id('com.arivoc.kouyu:id/tv_already_schools').text == '请选择所在学校':
    ...
    time.sleep(1)
    #area_rdoBtn_city = driver.find_element_by_android_uiautomator('new UiSelector().text("东城")').click()
    area_rdoBtn_city = driver.find_elements_by_id('com.arivoc.kouyu:id/area_rdoBtn')[1].click()

    time.sleep(1)
    #area_rdoBtn_area = driver.find_element_by_android_uiautomator('new UiSelector().text("东城区")')
    area_rdoBtn_area = driver.find_elements_by_id('com.arivoc.kouyu:id/area_rdoBtn')[1].click()
    time.sleep(1)
    #area_rdoBtn_school = driver.find_element_by_android_uiautomator('new UiSelector().text("口语100演示域")')
    ...
    spinner_schools = driver.find_element_by_android_uiautomator('new UiSelector().text("修改")')
    ...
    #area_rdoBth_province = driver.find_element_by_android_uiautomator('new Selector().text("东城")')
    area_rdoBtn_province = driver.find_elements_by_id('com.arivoc.kouyu:id/content')[0].click()
    time.sleep(1)
    #area_rdoBtn_city = driver.find_element_by_android_uiautomator('new UiSelector().text("东城")')
    area_rdoBtn_city = driver.find_elements_by_id('com.arivoc.kouyu:id/area_rdoBtn')[1].click()
