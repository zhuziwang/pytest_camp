...
class AppKey(AppiumKeys):
    ...
    def new_version_tips(self):
        ...
        if self.driver.find_elements_by_id('com.arivoc.kouyu:id/tv_title_upload'):
            ...
            update_text = self.test_element('id', 'com.arivoc.kouyu: id / tv_content_update').text()
        else:
            pass
    ...
    def login_update(self, school='', username='', password=''):
        ...
        if self.driver.find_elements_by_id('com.arivoc.kouyu:id/tv_already_schools'):
            ...
            if school_name == school:
                ...
                self.test_element('xpath',
                                  '/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget'
                                  '.FrameLayout/android.widget.LinearLayout/android.widget.LinearLayout[2]/android'
    ...
    def work_info_list(self, work_info_text=''):
        ...
        """
        for i in range(1, 6):
            xpath_num = '/hierarchy/android.widget.FrameLayout/android' \
                       ...
                       '.widget.ListView/android.widget.LinearLayout/android.widget.RelativeLayout/android' \
                       '.widget.ListView/android.widget.LinearLayout[%s]/android.widget.TextView' % i
        ...
        if i == 5 and work_info_text is not xpath_text:
            ...
            for i in range(1, 6):
                xpath_num = '/hierarchy/android.widget.FrameLayout/android.widget' \
                           '.LinearLayout/android.widget.FrameLayout/android.widget' \
                            '.LinearLayout/android.widget.FrameLayout/android.widget' \
                            '.LinearLayout/android.widget.ListView/android.widget.LinearLayout/android' \
                            '.widget.RelativeLayout/android.widget.ListView/android.widget' \
                            '.LinearLayout[%s]/android.widget.TextView' % i
                xpath_text = self.test_element('xpath', xpath_num).text
                if work_info_text in xpath_text:
                    self.test_element('xpath', xpath_num).click()
                    break
            ...
            if i == 5 and work_info_text is not xpath_text:
                self.swipe(326, 931, 328, 297, 1000)
                for i in range(1, 7):
                    xpath_num = '/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android' \
                                '.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android' \
                                '.widget.LinearLayout/android.widget.ListView/android.widget.LinearLayout/android' \
                                '.widget.RelativeLayout/android.widget.ListView/android.widget' \
                                '.LinearLayout[%s]/android.widget.TextView' % i
                    xpath_text = self.test_element('xpath', xpath_num).text
                    if work_info_text in xpath_text:
    ...
    def word_option(self):
        ...
        for i in range(0, over_jindu):
            ...
            fanyi0 = AppiumKeys.pymysql(sql0)
            if str(fanyi0) == 'None':
                fanyi1 = AppiumKeys.pymysql(sql1)
                eng_fanyi = fanyi1[0]
            else:
                eng_fanyi = fanyi0[0]
