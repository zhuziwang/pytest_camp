...
headers = {
    'user-agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML,'
                  ' like Gecko) Chrome/94.0.4606.61 Safari/537.36 Edg/94.0.992.31',
...
class Request:
    @staticmethod
    def get(url=None, payload=None, Deserved_results=None):
        """
        get方式请求，返回的值
        :param url:
    ...
    @staticmethod
    def post_json(url=None, payload=None, Deserved_results=None):
        """
...
class Request_web(Request):
    ...
    def fanyi():
        ...
        r = requests.post('https://fanyi.baidu.com/#zh/en/%s' % a, data={'token': 'a8b7123ebcd57bfc77e8f4c9ca671cea'},
